$(function () {
	...
	var options = {
        ...
        labels: ['Trail 1', 'Trail 2', 'Trail 3', 'Trail 4', 'Trail 5'],
        };
    ...
    // chart 20
	const span = document.querySelector("#chart_student_time_taken");
	var options = {
     ...
     // chart 20
	const span = document.querySelector("#admin_chart_student_time_taken");
	var options = {
          series: JSON.parse(span.dataset.scores),
          chart: {
			  foreColor: '#000000',
        ...
        var chart = new ApexCharts(document.querySelector("#admin_chart_student_time_taken"), options);
        chart.render();
