$(function () {
	...
	// chart 13
	const span1 = document.querySelector("#chart13");
	var options = {
          series: JSON.parse(span1.dataset.scores),
          chart: {
			  foreColor: '#000000',
          height: 350,
          type: 'radialBar',
		...
		colors: ["#4ED3FF", "#4ED3FF", "#4ED3FF", "#4ED3FF", "#4ED3FF"],
    ...
    // chart 20
	const span2 = document.querySelector("#chart_student_time_taken");
	var options = {
          series: JSON.parse(span2.dataset.scores),
          chart: {
			  foreColor: '#000000',
          height: 350,
          type: 'radialBar',
        ...
        var chart = new ApexCharts(document.querySelector("#chart_student_time_taken"), options);
        chart.render();
	
    
     // chart 20
	const span = document.querySelector(".chart_student_time_taken1");
	var options = {
          series: JSON.parse(span.dataset.scores),
          chart: {
			  foreColor: '#000000',
          height: 350,
          type: 'radialBar',
        ...
        var chart = new ApexCharts(document.querySelector("#section1"), options);
        chart.render();
