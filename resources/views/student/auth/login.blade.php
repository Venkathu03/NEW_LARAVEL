...
<head>
	...
	<title>Medisim Student Login</title>
</head>
								...
								<div class="border p-4 rounded" style="border-color: #ffffff!important;">
									...
									<div class="form-body">
										<form class="row g-3" method="post" action="{{ route('student.login')}}">
											...
											<div class="col-md-6 text-end">	<a href="{{ url('student/forget-password')}}" style="text-align: left; font-size: 14px; font-family: Gilroy-Regular">Forgot Password ?</a>
											</div>
											<div class="col-12">
												<div class="d-grid">
												...
												<div class="login-separater text-center mb-4"> <span>OR</span>
												 <hr/>
													...
													<div class="text-center">
														<p>New User? <a href="{{ url('student/signup')}}">Sign Up</a>
														</p>
													</div>
