...
<head>
	...
	<title>Medisim Student Forget Password</title>
    <style>
							...
							<div class="card-body">
								<div class="border p-4 rounded" style="border-color: #ffffff!important;">
									...
									<div class="text-center">
										<h3 class="" style="text-align: left; font-size: 32px; font-family: Gilroy-SemiBold">Forgot Password</h3>
										<br>	
									</div>
									<div>
									...
									<div class="form-body">
										<form class="row g-3" action="{{ route('student.forget.otp')}}" method="post">
                                            @csrf
											<div class="col-12">
												<label for="inputEmailAddress" class="form-label" style="text-align: left; font-size: 16px; font-family: Gilroy-Medium">Mobile Number</label>
												<input type="number" class="form-control" id="mobile" placeholder="Enter Mobile Number" name="mobile" required><br><br>
											</div>
											
											
											<div class="col-12">
												<div class="d-grid">
													<button type="submit" class="btn btn-primary" style="text-align: center; font-size: 20px; font-family: Gilroy-SemiBold">Send OTP</button>
												</div>
