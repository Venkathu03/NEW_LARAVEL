				...
				<nav class="navbar navbar-expand">
								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									<div class="header-message-list">
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1">
													<h6 class="msg-name">{{ auth('student')->user()->fullname}} <span class="msg-time float-end">5 sec
												ago</span></h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
                                                @if(!is_null(auth('student')->user()->avatar))
												<img src="{{asset('setting/'.auth('student')->user()->avatar)}}" class="msg-avatar" alt="user avatar">
                                                @else
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                             @if(!is_null(auth('student')->user()->avatar))
								<img src="{{asset('setting/'.auth('student')->user()->avatar)}}" class="user-img" alt="user avatar">
                            @else
