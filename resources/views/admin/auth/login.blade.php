							...
							<div class="card-body">
								<div class="border p-4 rounded" style="border-color: #ffffff!important;">
									...
									<div class="text-center">
										<h3 class="" style="text-align: left; font-size: 32px; font-family: Gilroy-SemiBold">Login</h3>
										<br><br>
									...
									<div class="form-body">
										<form class="row g-3" action="{{route('admin.login')}}" method="post">
											...
											<div class="col-12">
												...
												<input type="email" required class="form-control" name="email" id="inputEmailAddress" placeholder="Email Address">
											</div>
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" required name="password" class="form-control" id="inputChoosePassword" placeholder="Enter Password"> 
												</div>
											</div>
											
											<div class="col-md-6">
												<div class="form-check form-switch" style="padding-left: 0px">
													<input type="checkbox"  value="lsRememberMe" id="rememberMe"> <label for="rememberMe"  style="text-align: left; font-size: 14px; font-family: Gilroy-Regular">Remember me</label>
