...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    <script src="{{ asset('assets/js/time-taken.js')}}"></script>
...
<div class="row row-cols-1 row-cols-xl-2">
  ...
  @foreach(array_reverse($item['type_value']) as $typeIndex=>$procedure_type)
   @if(isset($procedure_type['procedure_type_name']))
  ...
  <script>
      ...
      $( document ).ready(function() {
          ...
          $(".barChart122").each(function(){
            const values = $(this).data("scores"); // Corrected array syntax
            // Dynamically calculate background color based on value
